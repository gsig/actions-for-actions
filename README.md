...
**Please see the [tool/](tool/), [oracles/](oracles/), and [error_analysis/](error_analysis/) subdirectories for the visualization tools and attributes for Charades! Let me know if you run into any problems.**
